package com.example.ecommerceapplication.nocycles;
...
public class NoCycleTest {
    private JavaClasses importedClasses = new ClassFileImporter().importPackages("com.example.ecommerceapplication.solution");
